...
4. **Can it be solved with an existing dependency?:** Do not install new packages if existing installed libraries (`zod`, `tailwind`, `prisma`, `lucide-react`) can solve it.
