    ...
    <div className="space-y-8 animate-in fade-in duration-700 pb-10">
          ...
          <div className="space-y-1.5 flex flex-col">
            <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Search</label>
             <div className="relative w-full">
               ...
               <input type="text" name="q" defaultValue={q} placeholder="Search names or status..." className="h-11 w-full pl-9 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 text-sm font-medium focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 outline-none transition-all shadow-sm" />
             </div>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-slate-200 dark:border-slate-800/60 bg-white dark:bg-slate-900">
          <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-slate-500/10 blur-2xl transition-all duration-500 group-hover:bg-slate-500/20" />
        ...
        <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-slate-200 dark:border-slate-800/60 bg-white dark:bg-slate-900">
          ...
          <CardContent className="p-6">
            ...
            <p className="text-3xl font-black tracking-tight text-emerald-600 dark:text-emerald-500">{presentDays.toLocaleString("en-IN")}</p>
          </CardContent>
        </Card>
        ...
        <Card className="group relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-rose-200 bg-rose-50/50 dark:border-rose-900/50 dark:bg-rose-950/20">
          <div className="absolute -right-8 -top-8 h-28 w-28 rounded-full bg-rose-500/10 blur-2xl transition-all duration-500 group-hover:bg-rose-500/20" />
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-3xl font-black tracking-tight text-rose-600 dark:text-rose-500">{absent.toLocaleString("en-IN")}</p>
          </CardContent>
        </Card>
      </div>
